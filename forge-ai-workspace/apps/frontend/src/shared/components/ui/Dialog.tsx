// File: apps/frontend/src/shared/components/ui/Dialog.tsx
// Purpose: Modal dialog primitives (Radix Dialog) — fade+scale 150ms per Phase 7 §8
  ...
  <DialogPrimitive.Portal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-lg border bg-surface p-5 shadow-lg duration-150',
